...
// Usage (from examples/):
//
//	go run ./agent_conversation/list_all_archived_conversations <path-to-.env>
package main
...
func main() {
	if len(os.Args) < 2 {
		log.Fatal("usage: go run ./agent_conversation/list_all_archived_conversations <path-to-.env>")
	}
