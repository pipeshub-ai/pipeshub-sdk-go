...
// WebSearch - Manage web search providers (DuckDuckGo, Serper, Tavily, Exa) and settings for internet search.
...
func newWebSearch(rootSDK *Pipeshub, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *WebSearch {
	return &WebSearch{
		rootSDK:          rootSDK,
...
func (s *WebSearch) GetWebSearchProviders(ctx context.Context, opts ...operations.Option) (*operations.GetWebSearchProvidersResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/configurationManager/web-search")
	if err != nil {
	...
	res := &operations.GetWebSearchProvidersResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.WebSearchProvidersResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.WebSearchProvidersResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
