...
// PatListItem - A personal access token as seen by its own creator (one element of
...
func (p PatListItem) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(p, "", false)
}

func (p *PatListItem) UnmarshalJSON(data []byte) error {
...
func (p *PatListItem) GetID() string {
	if p == nil {
		return ""
	}
	return p.ID
...
func (p *PatListItem) GetName() string {
	if p == nil {
		return ""
	}
	return p.Name
...
func (p *PatListItem) GetScopes() []string {
	if p == nil {
		return []string{}
	}
	return p.Scopes
...
func (p *PatListItem) GetCreatedAt() time.Time {
	if p == nil {
		return time.Time{}
	}
	return p.CreatedAt
...
func (p *PatListItem) GetExpiresAt() time.Time {
	if p == nil {
		return time.Time{}
	}
	return p.ExpiresAt
...
func (p *PatListItem) GetLastUsedAt() *time.Time {
	if p == nil {
		return nil
	}
	return p.LastUsedAt
